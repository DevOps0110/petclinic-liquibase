...
<nav class="navbar navbar-default" role="navigation">
    <div class="container" style="background-color: #6db33f; border-bottom:2px solid black; width: 100%">
    <h1 style = "text-align:center;font-weight: bold;color: #ffffff">Petclinic DAC-DevOps</h1>
    </div>
    <div class="container">
